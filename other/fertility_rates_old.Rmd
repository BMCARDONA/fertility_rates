---
title: "Total Fertility Rate by Geographic Region (1960-2021)"
...
#### Case Study Outline:
- Question: What was the Total Fertility Rate by Geographic Region from 1960 to 2021?
- Data set: [World Bank](https://data.worldbank.org/indicator/SP.DYN.TFRT.IN?end=2021&start=2021&view=map&year=2021)


#### Abstract: 
- The Total Fertility Rate (TFR) is a measure of the average number of children that would be born to a woman over her lifetime if she were to experience the exact current age-specific fertility rates through her lifetime and were to live from birth until the end of her reproductive life. It is often said that the world is experiencing or will experieince an overpopulation problem. This analysis suggests, however, that the problem is actually the opposite. Due to the dramatic drop in TFRs across nearly every country for the last several decades, we believe that most countries will experience an underpopulation problem.
...
```
Each data point in Figure 1 represents a different country. These data points suggest that there has been a considerable decrease in total fertility rates from 1960 to 2021. Let's further analyze this trend.
...
p <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate in European Countries (1960-2021)") +
...
p <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate in African Countries (1960-2021)") +
  scale_x_discrete(breaks = seq(1960, 2021, by = 5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "bottom") +
  guides(color = guide_legend(ncol = 3))
...
p <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate in Asian Countries (1960-2021)") +
  scale_x_discrete(breaks = seq(1960, 2021, by = 5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "bottom") +
  guides(color = guide_legend(ncol = 3))
...
p <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate in North American Countries (1960-2021)") +
  scale_x_discrete(breaks = seq(1960, 2021, by = 5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "bottom") +
  guides(color = guide_legend(ncol = 3))
...
p <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate in South American Countries (1960-2021)") +
  scale_x_discrete(breaks = seq(1960, 2021, by = 5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "bottom") +
  guides(color = guide_legend(ncol = 3))
...
p <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate in Oceanic Countries (1960-2021)") +
  scale_x_discrete(breaks = seq(1960, 2021, by = 5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "bottom") +
  guides(color = guide_legend(ncol = 3))
...
#### Total Fertility Rate by Geographic Region (1960-2021)
```{r fig.align='center', fig.height = 8}
...
p1 <- ggplot(fertility_rates_long, 
  ...
  xlab("Year") +
  ylab("Fertility Rate") +
  ggtitle("Total Fertility Rate by Region (1960-2021)") +
  scale_x_discrete(breaks = seq(1960, 2021, by = 5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
...
# trend in terms of total fertility rate. To make this more clear, 
...
- Click [here](https://public.tableau.com/app/profile/bradley.cardona/viz/AverageFertilityRatebyRegion1960-2021/Dashboard2) to see this project's Tableau dashboard.

## Step 8: Identify pattern
From the dashboard, it appears that nearly every country has experienced a sharp decrease in total fertility rates. Let's make sure our analysis is correct.
## Step 9: Graph 
...
plots <- fertility_data %>%
  ...
  map(~ .x[order(.x$mean_pct_change),] %>%
    ...
    labs(x = "Country Name", y = "Percentage Change in Total Fertility Rate (%)", title = paste("Percentage Change in Total Fertility Rate by Country in", unique(.x$Region))))
...
generate_plot("Europe", european_countries, fertility_rates, "Country Name",
              "Documents/data_analytics/fertility_rate_case_study/new_figures")
